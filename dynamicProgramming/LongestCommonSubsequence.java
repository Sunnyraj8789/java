public class LongestCommonSubsequence {
    ...
    public static int lcsMemo(String s1,String s2,int m,int n,int[][] dp){
        ...
        //optimzation--avoid the recomputation of the same function calls
        ...
        if(s1.charAt(m-1)==s2.charAt(n-1)){
            ...
            return dp[m][n]=Math.max(lcsMemo(s1, s2, m-1, n,dp) , lcsMemo(s1, s2, m, n-1,dp));
        }
    }
    //function defination of lcs using the recursive approach
